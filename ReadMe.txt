===========================================================================
【 ソフト名 】　Aipo支援ツール「Aipoリマインダー｣ Ver 1.0.8.0
【 登 録 名 】　AipoReminder1080.zip
【 圧縮形式 】　zip
...
--  インストール方法  -----------------------------------------------------
---------------------------------------------------------------------------
　AipoReminder1080.zipを任意のディレクトリに解凍してください。
　解凍後のフォルダ名をAipoReminder1080からAipoReminderに変更しておくと後々のアップデート時にスムーズにアップデートが出来ます。
