===========================================================================
【 ソフト名 】　Aipo支援ツール「Aipoリマインダー｣ Ver 1.1.1.0
【 登 録 名 】　AipoReminder1.1.1.0.zip
【 圧縮形式 】　zip
【 作 成 者 】　Copyright (C) 2009-2012 k.kobayashi
【  WebSite 】　なし
...
--  既知のバグ  -----------------------------------------------------------
---------------------------------------------------------------------------
・掲示板の新着情報が何度も表示される場合がある

---------------------------------------------------------------------------
--  今後の予定  -----------------------------------------------------------
---------------------------------------------------------------------------
・.NET Framework4への移行
・非公開と完全に隠すスケジュールでもポップアップされるように
・ブラウザの候補を自動的に取得するのではなく、ユーザが選択出来るように

---------------------------------------------------------------------------
--  改版履歴  -------------------------------------------------------------
---------------------------------------------------------------------------
■ Ver 1.1.1.0 (2012/04/21)
　【バグ】
　・ログイン設定保存時にバージョンのコンボボックスが非活性にならないバグを修正
　・バージョン6を選択した時点で新着情報のチェックボックスをすべてオフにしてから変更出来ないように修正
　・同時に大勢に伝言を送った場合、それ以降新着情報が正しく取得出来なくなっていたバグを修正
...
　　→Npgsqlのバグ修正に対する修正を行った
　・自動ログイン処理を修正した

　【機能追加】
　・ブラウザを指定出来るようにした

■ Ver 1.0.9.2 (2010/05/01)
　【バグ】
　・Windowsの終了時にタイムカード連携機能が動いていなかったバグを修正
